...
class CheXbert(nn.Module):
    def __init__(self, checkpoint_path, device, p=0.1):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('/picassox/kh-mvv-data/digital-human/workspace/code/fzw/utils/metric/checkpoints/bert-base-uncased')
        config = BertConfig().from_pretrained('/picassox/kh-mvv-data/digital-human/workspace/code/fzw/utils/metric/checkpoints/bert-base-uncased')
